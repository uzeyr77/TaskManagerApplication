...
//        Task.TaskManagerImpl tm = new Task.TaskManagerImpl();
//
//
...
//
//        assertTrue(output.contains("Task.Task added Successfully (junit)"));
//
//
//    }
//
...
//    System.out.println(output);
//
//    assertTrue(output.contains("Task.Task has been deleted successfully"));
//
//    }
//
//    @Test
...
//
//        //System.out.println(output);
//    assertTrue(output.contains("Task.Task 1 successfully updated"));
//
    ...
    void run_testingListingAllTasks() {
        ...
        //assertTrue(output.contains("Task.Task{id=1, description='to coffee shop', status='to-do', created at= '2025-08-14', updated at= 'N/A'} Task.Task{id=2, description='for a run', status='to-do', created at= '2025-08-14', updated at= 'N/A'} Task.Task{id=3, description='groceries', status='in-progress', created at= '2025-08-14', updated at= 'N/A'}"));
    }
...
//        String output = outputBuffer.toString();
//
//        assertTrue(output.contains("Task.Task{id=1, description='go for a run', status='in-progress', created at= '2025-08-15', updated at= 'N/A'} Task.Task{id=2, description='go to the shops and buy a khamis', status='in-progress', created at= '2025-08-15', updated at= 'N/A'} Task.Task{id=3, description='find a wife', status='in-progress', created at= '2025-08-15', updated at= 'N/A'}"));
//    }
//
//
//    @Test
...
//        String output = outputBuffer.toString();
//
//        assertTrue(output.contains("Task.Task{id=1, description='go for a run', status='to-do', created at= '2025-08-15', updated at= 'N/A'} Task.Task{id=2, description='go to the shops and buy a khamis', status='to-do', created at= '2025-08-15', updated at= 'N/A'} Task.Task{id=3, description='find a wife', status='to-do', created at= '2025-08-15', updated at= 'N/A'}"));
//
//    }
//
//    @Test
...
//        System.out.println(output);
//
//        assertTrue(output.contains("Task.Task{id=2, description='go to the shops and buy a khamis', status='done', created at= '2025-08-15', updated at= 'N/A'} Task.Task{id=3, description='find a wife', status='done', created at= '2025-08-15', updated at= 'N/A'}"));
//
//    }
//
//    @Test
...
//
    ...
    void run_testDeletingTask() {
        ...
        assertTrue(output.contains("Task.Task 2 has been deleted"));
    }
    ...
    void run_testUpdatingTaskDescription() {
        ...
        assertTrue(output.contains("Task.Task 1 has been updated"));
    }
    ...
    void run_testListAll() {
        ...
        assertTrue(output.contains("Task.Task{id=1, description='go to the store', status='in-progress', created at= '2025-08-16', updated at= 'N/A'}"));
    }
    ...
    void run_testingListingTodo() {
        ...
        assertTrue(output.contains("Task.Task{id=2, description='go for a walk', status='to-do', created at= '2025-08-16', updated at= 'N/A'}"));
    ...
    void run_testingListingDone() {
        ...
        assertTrue(output.contains("Task.Task{id=3, description='buy milk', status='done', created at= '2025-08-16', updated at= 'N/A'}"));
    }
    ...
    void run_testingMarkInProgress() {
        ...
        assertTrue(output.contains("Task.Task 1 has been marked in progress"));
    ...
    void run_testingMarkTodo() {
        ...
        assertTrue(output.contains("Task.Task 3 has been marked as to-do"));
    }
    ...
    void run_testingMarkingDone() {
        ...
        assertTrue(output.contains("Task.Task 3 has been marked as done"));
    }
    @Test
